...
// End Cross Module References
	DEFINE_FUNCTION(UMCTS_Functions::execSimulateAI)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		UMCTS_Functions::SimulateAI(Z_Param_name,Z_Param_Out_output);
		P_NATIVE_END;
	}
	...
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMCTS_Functions_SimulateAI_Statics::NewProp_name = { "name", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MCTS_Functions_eventSimulateAI_Parms, name), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMCTS_Functions_SimulateAI_Statics::NewProp_output = { "output", nullptr, (EPropertyFlags)0x0010000000000180, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(MCTS_Functions_eventSimulateAI_Parms, output), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMCTS_Functions_SimulateAI_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMCTS_Functions_SimulateAI_Statics::NewProp_name,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMCTS_Functions_SimulateAI_Statics::NewProp_output,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMCTS_Functions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UMCTS_Functions_SimulateAI, "SimulateAI" }, // 4185898287
	};
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Git_KBG_Source_KBG_Public_MCTS_Functions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMCTS_Functions, UMCTS_Functions::StaticClass, TEXT("UMCTS_Functions"), &Z_Registration_Info_UClass_UMCTS_Functions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMCTS_Functions), 1460021016U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Projects_Git_KBG_Source_KBG_Public_MCTS_Functions_h_2946280072(TEXT("/Script/KBG"),
